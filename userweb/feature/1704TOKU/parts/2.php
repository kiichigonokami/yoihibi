...
.text_ver_b { font-weight: bold; color: #19929f;}
...
.item_detail_ttl_name { border-color: #19929f!important;}
.intoroduction_1812TOKU {text-align: left; margin: -20px 1% 60px; width: 98%; position: relative; padding: 2.5% 2% 2%; background: rgba(255, 255, 255, 0.9); color: #333; -moz-border-radius: 10px; -webkit-border-radius: 10px; border-radius: 10px; -moz-box-shadow: 0 0 20px rgba(25, 146, 159, 0.9); -webkit-box-shadow: 0 0 20px rgba(25, 146, 159, 0.9); box-shadow: 0 0 20px rgba(25, 146, 159, 0.9); display: block; overflow: hidden;}

h3.article_detail_contents_box__title { color: #19929f !important; font-weight: bold; font-size: 140%; border: none !important; margin: 0 0 0 0;}
h3.article_detail_contents_box__title:before { content: ''; display: inline-block; width:30px; height:30px; vertical-align: middle; position: relative; top: -4px; padding: 0 15px 0 0; background: url(https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1704TOKU/h2_before.png) no-repeat; background-size:contain;}

span.item_detail_feature_title,
h3.article_detail_contents_box__title {color:#19929f !important;}
...
.intoroduction_1812TOKU { margin: 20px 2% 20px; width: auto; font-size: 14px; padding: 10px;}
...
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1704TOKU/title.png" width="100%;" style="margin: 0 0 50px 0;" class="spnone">
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1704TOKU/title_s.png" width="100%;" style="margin: 0 0 0 0;" class="pcnone">

<div class="intoroduction_1812TOKU">
