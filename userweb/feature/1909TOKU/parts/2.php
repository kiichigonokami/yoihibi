...
.item_detail_ttl_name { border-color: #004d86!important;}
...
h3.article_detail_contents_box__title { color: #004d86 !important; font-weight: bold; font-size: 140%; border: none !important; margin: 0 0 0 0;}
h3.article_detail_contents_box__title:before { content: ''; display: inline-block; width:30px; height:30px; vertical-align: middle; position: relative; top: -4px; padding: 0 15px 0 0; background: url('https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1909TOKU/h2_before.png') no-repeat; background-size:contain;}

span.item_detail_feature_title,
h3.article_detail_contents_box__title {color:#004d86 !important;}
...
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1909TOKU/title.png" width="100%;" style="margin: 0 0 50px 0;" class="spnone">
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1909TOKU/title_s.png" width="100%;" style="margin: 0 0 0 0;" class="pcnone">

<div class="article_detail_text">
  <p>　身の回りに増え続ける有害な化学物質。浄化や解毒が必要とわかっていても、緊急性を感じない方も多いと思います。大人になってから発症したアレルギーや、原因はわからないけれど何となく調子が悪い、ということも有害物質が原因の可能性もあります。
　健康に悪影響を与える有害物質とそれらを浄化・解毒するための対策などについて、食生活・医学ジャーナリストの氏家京子さんにご寄稿いただきました。</p>
</div>
...
<div class="article_detail_mokuji">
  ...
  <ul>
    <a href="#toku-ttl1"><li>“解毒”は生命活動の一部です</li></a>
    <a href="#toku-ttl2"><li>悪い食習慣は骨が弱くなる!?</li></a>
    <a href="#toku-ttl3"><li>体内で分解できないものが、有害物質</li></a>
    <a href="#toku-ttl4"><li>有害物質はどこから排出される？</li></a>
    <a href="#toku-ttl5"><li>入れない工夫、出す対策</li></a>
    <a href="#toku-ttl6"><li>浄化・解毒を助ける栄養は？</li></a>
    <a href="#kiji_prof"><li>氏家京子さんプロフィール</li></a>
  </ul>
</div>
