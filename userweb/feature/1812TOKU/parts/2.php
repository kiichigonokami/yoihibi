...
.item_detail_ttl_name { border-color: #b72914!important;}
.intoroduction_1812TOKU {text-align: left; margin: -20px 1% 60px; width: 98%; position: relative; padding: 2.5% 2% 2%; background: rgba(255, 255, 255, 0.9); color: #333; -moz-border-radius: 10px; -webkit-border-radius: 10px; border-radius: 10px; -moz-box-shadow: 0 0 20px rgba(183, 41, 20, 0.9); -webkit-box-shadow: 0 0 20px rgba(183, 41, 20, 0.9); box-shadow: 0 0 20px rgba(183, 41, 20, 0.9); display: block; overflow: hidden;}

h3.article_detail_contents_box__title { color: #b72914 !important; font-weight: bold; font-size: 140%; border: none !important; margin: 0 0 0 0;}
h3.article_detail_contents_box__title:before { content: ''; display: inline-block; width:30px; height:30px; vertical-align: middle; position: relative; top: -4px; padding: 0 15px 0 0; background: url(https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1812TOKU/h2_before.png) no-repeat; background-size:contain;}

span.item_detail_feature_title,
h3.article_detail_contents_box__title {color:#b72914 !important;}
...
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1812TOKU/title.png" width="100%;" style="margin: 0 0 50px 0;" class="spnone">
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1812TOKU/title_s.png" width="100%;" style="margin: 0 0 0 0;" class="pcnone">

<div class="intoroduction_1812TOKU">
　日ごとに寒さが増し、屋外と室内のみならず、家の中でも寒暖差が大きくなり、急激な温度変化によるからだへの負担が心配な季節です。血圧が大きく変動し、血管にダメージを与えるヒートショックにも用心しなければいけません。<br>
