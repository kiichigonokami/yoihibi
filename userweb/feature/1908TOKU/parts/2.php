...
h3.article_detail_contents_box__title:before { content: ''; display: inline-block; width:30px; height:30px; vertical-align: middle; position: relative; top: -4px; padding: 0 15px 0 0; background: url('https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1908TOKU/h2_before.png') no-repeat; background-size:contain;}
...
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1908TOKU/title.png" width="100%;" style="margin: 0 0 50px 0;" class="spnone">
<img src="https://aladdinec.jp/client_info/FLORAHOUSE01/view/userweb/images/feature/1908TOKU/title_s.png" width="100%;" style="margin: 0 0 0 0;" class="pcnone">

<div class="article_detail_text">
  <p>腸内環境が健康に大きく関わっていることがさまざまな研究から明らかになり、腸内環境やそこに生息する腸内細菌に注目が集まっています。最先端の知見と健康効果を高める腸内環境の整え方について医学博士・岡本裕先生に教えていただきます。</p>
</div>
...
<div class="article_detail_mokuji">
  ...
  <ul>
    <a href="#toku-ttl1"><li>腸内細菌に「善」「悪」はない？</li></a>
    <a href="#toku-ttl2"><li>腸内細菌はチームで働きます</li></a>
    <a href="#toku-ttl3"><li>自分の腸内環境を知る方法は？</li></a>
    <a href="#toku-ttl4"><li>「プロバイオティクス」から「プレバイオティクス」へ</li></a>
    <a href="#toku-ttl5"><li>こんなにすごい！発酵代謝物質「エンザミン」</li></a>
    <a href="#toku-ttl6"><li>毎日の生活習慣を見直して、腸内環境を整えましょう</li></a>
    <a href="#kiji_prof"><li>岡本裕先生プロフィール</li></a>
  </ul>
</div>
